package com.icsd.healthcare.security.service;


import com.icsd.healthcare.exceptionhandler.ErrorCode;
import com.icsd.healthcare.security.model.AuthenticationResponse;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(User request){
        ...
        try {
          ...
          User user = userRepository.findByEmail(request.getEmail()).orElseThrow(()-> new UserNotFoundException(ErrorCode.USER_NOT_FOUND_WITH_THIS_CREDENTIALS));
